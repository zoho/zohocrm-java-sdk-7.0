...
public class AllowedOutputData implements Model
{
	...
	/**
	 * The method to get the value of crmFields
	 * @return An instance of List<CrmField>
	 */
	 ...
	 * @param crmFields An instance of List<CrmField>
	 */
	public void setCrmFields(List<CrmField> crmFields)
	{
		 this.crmFields = crmFields;

		 this.keyModified.put("crm_fields", 1);
