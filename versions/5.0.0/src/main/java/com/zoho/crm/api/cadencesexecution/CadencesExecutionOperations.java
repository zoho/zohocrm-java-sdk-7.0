...
public class CadencesExecutionOperations
{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> enrolCadences(String module, BodyWrapper request) throws SDKException
	{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> unenrolCadences(String module, BodyWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
