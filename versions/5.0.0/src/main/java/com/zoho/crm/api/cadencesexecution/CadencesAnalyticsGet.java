...
public class CadencesAnalyticsGet implements Model
{
	...
	/**
	 * The method to get the value of followUps
	 * @return An instance of List<Analytics>
	 */
	public List<Analytics> getFollowUps()
	{
	 ...
	 * @param followUps An instance of List<Analytics>
	 */
	public void setFollowUps(List<Analytics> followUps)
	{
		 this.followUps = followUps;

		 this.keyModified.put("follow_ups", 1);
