...
public class UpdateRecordLockingConfigurations
{
	public static void updateRecordLockingConfigurations(String moduleName) throws Exception
	{
		...
		recordLock.setId(3477020938001l);
		...
		APIResponse<ActionHandler> response = recordLockingConfigurationOperations.updateRecordLockingConfigurations(bodyWrapper);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			updateRecordLockingConfigurations(moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
