...
import com.zoho.crm.api.usersterritories.UsersTerritoriesOperations.RemoveTerritoriesFromUserParam;
import com.zoho.crm.api.util.APIResponse;
import com.zoho.crm.api.util.Model;

public class RemoveTerritoriesFromUser
{
	public static void removeTerritoriesFromUser(Long userId) throws Exception
	{
		UsersTerritoriesOperations usersTerritoriesOperations = new UsersTerritoriesOperations(userId);
		ParameterMap paramInstance = new ParameterMap();
		paramInstance.add(RemoveTerritoriesFromUserParam.IDS, "");
		APIResponse<ActionHandler> response = usersTerritoriesOperations.removeTerritoriesFromUser(paramInstance);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			removeTerritoriesFromUser(userId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
