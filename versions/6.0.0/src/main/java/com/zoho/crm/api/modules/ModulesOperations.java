...
public class ModulesOperations
{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ResponseHandler> getModules(ParameterMap paramInstance, HeaderMap headerInstance) throws SDKException
	{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> createCustomModules(BodyWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ResponseHandler> getModuleByAPIName(String apiName) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ResponseHandler> getModule(Long id) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	...
	{
		public static final Param<Choice<String>> STATUS = new Param<Choice<String>>("status", "com.zoho.crm.api.Modules.GetModulesParam");
