...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getRecordLockingConfigurations()
	{
	 ...
	 * @param recordLockingConfigurations An instance of List<ActionResponse>
	 */
	public void setRecordLockingConfigurations(List<ActionResponse> recordLockingConfigurations)
	{
