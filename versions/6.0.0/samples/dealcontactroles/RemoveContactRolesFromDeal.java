...
public class RemoveContactRolesFromDeal
{
	public static void removeContactRolesFromDeal(Long dealId) throws SDKException
	{
		DealContactRolesOperations contactRolesOperations = new DealContactRolesOperations();
		ParameterMap paramInstance = new ParameterMap();
		paramInstance.add(DeleteAssociatedContactRolesParam.IDS, "34772418044");
		APIResponse<ActionHandler> response = contactRolesOperations.deleteAssociatedContactRoles(dealId, paramInstance);
		if (response != null)
		{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long dealId = 34770418049l;
			removeContactRolesFromDeal(dealId);
		}
		catch (Exception e)
		{
			e.printStackTrace();
