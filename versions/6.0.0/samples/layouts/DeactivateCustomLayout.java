...
import com.zoho.crm.api.layouts.LayoutsOperations.DeactivateCustomLayoutParam;
import com.zoho.crm.api.util.APIResponse;
import com.zoho.crm.api.util.Model;

public class DeactivateCustomLayout
{
	public static void deactivateCustomLayout(Long id, String moduleAPIName) throws Exception
	{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long id = 3477064657472l;
			deactivateCustomLayout(id, moduleAPIName);
		}
		catch (Exception e)
		{
			e.printStackTrace();
