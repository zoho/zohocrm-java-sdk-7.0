...
public class GetRelatedRecord
{
				...
				if (responseHandler instanceof ResponseWrapper)
				{
					...
					for (com.zoho.crm.api.record.Record record : records)
					{
						...
						for (Map.Entry<String, Object> entry : record.getKeyValues().entrySet())
						{
							...
							{
								com.zoho.crm.api.layouts.Layouts layout = (Layouts) value;
								if (layout != null)
								{
	...
	public static void main(String[] args)
	{
		try
		{
			...
			Long recordId = 347706120599002l;
			String relatedListAPIName = "Locking_Information__s";
			Long relatedListId = 347706120778004l;
