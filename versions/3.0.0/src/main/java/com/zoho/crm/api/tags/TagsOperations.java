...
public class TagsOperations
{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<RecordActionHandler> addTags(Long recordId, String moduleAPIName, NewTagRequestWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<RecordActionHandler> removeTags(Long recordId, String moduleAPIName, ExistingTagRequestWrapper request) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
