...
public class FieldsOperations
{
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> createField(BodyWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> updateFields(BodyWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> updateField(Long field, BodyWrapper request, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws SDKException
	 */
	public APIResponse<ActionHandler> deleteField(Long field, ParameterMap paramInstance) throws SDKException
	{
		CommonAPIHandler handlerInstance = new CommonAPIHandler();
	...
	public static class GetFieldsParam
	{
		...
		public static final Param<Choice<String>> TYPE = new Param<Choice<String>>("type", "com.zoho.crm.api.Fields.GetFieldsParam");
	...
	{
		public static final Param<String> MODULE = new Param<String>("module", "com.zoho.crm.api.Fields.CreateFieldParam");

	}

	public static class UpdateFieldsParam
	{
		public static final Param<String> MODULE = new Param<String>("module", "com.zoho.crm.api.Fields.UpdateFieldsParam");
	...
	{
		public static final Param<String> MODULE = new Param<String>("module", "com.zoho.crm.api.Fields.UpdateFieldParam");

	}

	public static class DeleteFieldParam
	{
		public static final Param<String> MODULE = new Param<String>("module", "com.zoho.crm.api.Fields.DeleteFieldParam");
