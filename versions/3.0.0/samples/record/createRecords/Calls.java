...
public class Calls
{
	public static void createCall(String moduleAPIName) throws Exception
	{
		...
		record1.addFieldValue(Field.Calls.REMINDER, new Choice<String>("5 minutes before"));
...
//		record1.addKeyValue("Voice_Recording__s", "recordingofcall.com");
		...
		fileDetail1.setFileIdS("ae9c7cefa418aec1d6a5cc2d9ab35c32a6ae23d729add280");
		fileDetails.add(fileDetail1);
		FileDetails fileDetail2 = new FileDetails();
		fileDetail2.setFileIdS("ae9c7cefa418aec1d6a5cc2d9ab35cca878a934519e6cdb2");
