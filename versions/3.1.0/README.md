...
2. Gradle
    ...
    dependencies{
        implementation 'com.zoho.crm:zohocrm-java-sdk-7-0:3.1.0'
    }
     ```
3. [Download SDK jar](https://maven.zohodl.com/com/zoho/crm/zohocrm-java-sdk-7-0/3.1.0/zohocrm-java-sdk-7-0-3.1.0.jar)
