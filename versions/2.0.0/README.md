...
2. Gradle
    ...
    dependencies{
        implementation 'com.zoho.crm:zohocrm-java-sdk-7-0:2.0.0'
    }
     ```
3. [Download SDK jar](https://maven.zohodl.com/com/zoho/crm/zohocrm-java-sdk-7-0/2.0.0/zohocrm-java-sdk-7-0-2.0.0.jar)
