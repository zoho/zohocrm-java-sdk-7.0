...
public class ActionWrapper implements Model, ActionHandler
{
	 ...
	 */
	public List<ActionResponse> getZiaorgenrichment()
	{
	 ...
	 * @param ziaorgenrichment An instance of List<ActionResponse>
	 */
	public void setZiaorgenrichment(List<ActionResponse> ziaorgenrichment)
	{
