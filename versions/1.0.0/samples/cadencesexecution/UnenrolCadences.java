...
{
	public static void unenrolCadences(String moduleAPIName) throws Exception
	{
		...
		ids.add("347750001");
		request.setIds(ids);
		APIResponse<ActionHandler> response = cadencesExecutionOperations.unenrolCadences(moduleAPIName, request);
		if (response != null)
		{
