...
public class UpdateFields
{
	public static void updateFields(String module) throws Exception
	{
		...
		APIResponse<ActionHandler> response = fieldsOperations.updateFields(bodyWrapper, paramInstance);
		if (response != null)
		{
