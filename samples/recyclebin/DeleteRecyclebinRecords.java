...
import com.zoho.crm.api.recyclebin.ActionHandler;
import com.zoho.crm.api.recyclebin.ActionResponse;
import com.zoho.crm.api.recyclebin.ActionWrapper;
import com.zoho.crm.api.recyclebin.RecycleBinOperations;
import com.zoho.crm.api.recyclebin.SuccessResponse;
import com.zoho.crm.api.recyclebin.RecycleBinOperations.DeleteRecycleBinRecordsParam;
...
{
	public static void deleteRecyclebinRecords() throws Exception
	{
		...
		if (response != null)
		{
			...
			if (response.isExpected())
			{
				...
				if (actionHandler instanceof ActionWrapper)
				{
					...
					List<ActionResponse> actionResponses = actionWrapper.getRecycleBin();
